...
class KakaoNotificationSenderTest {
    private static final String BASE_URL = "http://kakaotalk.test";
    private static final String PATH = "/send/kakaotalk";

    private MockRestServiceServer mockServer;
    private KakaoNotificationSender sender;
    ...
    void setUp() {
        ...
        properties.setChannels(Map.of(ChannelType.KAKAOTALK, config));

        sender = new KakaoNotificationSender(
    ...
    void convertsToSuccessWhenResponseOk() {
        mockServer.expect(requestTo(BASE_URL + PATH))
                ...
                .andExpect(jsonPath("$.talkId").value("010-1234-5678"))
